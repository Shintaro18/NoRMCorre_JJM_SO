...
%folder = 'C:\Box\Anis Laboratory\programs\MiniscopeUtilities\NoRMCorre_JJM-master';
folder = '../mc';
addpath(folder); 
name = 'msCam13short.avi';

%{
% For debugging of exporting file in the quest
A  = rand(10,1);
B = rand(10,1);
T = table(A, B, 'VariableNames', { 'A', 'B'} )
writetable(T, 'DebugFile.txt')
%}
...
if make_avi
    vidObj = VideoWriter(strcat(folder,'/', name(1:end-4),'_display','.avi'));
